...
const WEBHOOK_ENV = { isuls: "DISCORD_WEBHOOK_ISULS", dsls: "DISCORD_WEBHOOK_DSLS", mmls: "DISCORD_WEBHOOK_MMLS", ssmls: "DISCORD_WEBHOOK_SSMLS" };
...
function sanitizeEmbed(embed) {
  ...
  const fields = Array.isArray(embed.fields) ? embed.fields.slice(0, 25).map(field => ({
